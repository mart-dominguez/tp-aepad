...
--
-- Host: localhost    Database: aepad-tp-bk
-- ------------------------------------------------------
...
--
-- Current Database: `aepad-tp-bk`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `aepad-tp-bk` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
CREATE TABLE `ordencompra` (
  ...
  `FECHA` date DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=35001 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=122486 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Current Database: `aepad-tp`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `aepad-tp` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
-- Dump completed on 2018-04-25 16:22:15
